        ...
        <>
            <div style={{ textAlign: 'center' }}>
                ...
                <p>
                    ...
                    O dano será calculado com base nas estatísticas de cada monstro, e o resultado será mostrado abaixo até que um deles tenha seus pontos de vida reduzidos a zero.
                </p>
            </div>
            ...
            {winner ? <h1 className="result">O vencedor é: {winner.name}</h1> : null}
        </>
    );
}
